...
# Keywords that indicate boilerplate / low-quality / DISHONEST
...
# Explicitly "Dishonest" patterns from GOVERNANCE_ANTI_LOBOTOMY.md §12
DISHONEST_PATTERNS = [
...
class TextbookFilter:
    ...
    def __init__(
        ...
        self.thresholds = {
            ...
            'structural_honesty': honesty_threshold,
        }
    ...
    def _assess_structural_honesty(self, text: str, report: QualityReport) -> QualityReport:
        """Evaluate alignment with GOVERNANCE_ANTI_LOBOTOMY.md §12.
        Rejects placeholders, literal TODOs, and fake data structures.
        """
        dishonest_hits = 0
        ...
        if dishonest_hits > 0:
            report.structural_honesty = max(0.0, 1.0 - dishonest_hits * 0.5)
        else:
